...
const Footer = () => {
  return (
    <div id="footer-container">
      ...
      <div className="f2">
        This website is cloned by Ayush chaubey
      </div>
      <div className="accounts">
      <a href="https://github.com/ayushchaubey17/" class="a1"><i class="fa-brands fa-github"></i></a>
      <a href="mailto:ayush96361570@gmail.com" class="a1"><i class="fa-solid fa-envelope"></i></a>
      <a href="https://www.linkedin.com/in/ayush-kumar-chaubey-6a6745264/" class="a1"><i class="fa-brands fa-linkedin"></i></a>
      <a href="https://ayushchaubey17.github.io/portfolio/" class="a1"><i class="fa-solid fa-user-tie"></i></a>
